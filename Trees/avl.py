...
# Description: This program uses the BST code to implement the AVL tree operations.
...
class AVL(BST):
    ...
    def add(self, value: object, current_node = None) -> None:
        ...
        Returns: None
        Description: Adds a value to the tree like a BST but readjusts to be balanced.
        """
    ...
    def _balance_factor(self, node: AVLNode) -> int:
        """
        Method: _balance_factor()
        Parameters: node: AVLNode
        Returns: int
        Description: Obtains the balance factor of the desired node.
        """
        if not node:
            return 0
    ...
    def _get_height(self, node: AVLNode) -> int:
        ...
        Parameters: node: AVLNode
        Returns: int
        Description: Gets height of specified node in tree.
        """
        if not node:
            return 0
    ...
    def _rotate_left(self, node: AVLNode) -> AVLNode:
        ...
        Parameters: node: AVLNode
        Returns: AVLNode
        Description: Helper method to rotate AVL Node left to help with balancing.
        """
        rot_node = node.right
        temp = rot_node.left
        ...
        self._update_height(rot_node)

        return rot_node

    def _rotate_right(self, node: AVLNode) -> AVLNode:
        """
        Method: _rotate_right()
        Parameters: node: AVLNode
        Returns: AVLNode
        Description: Helper method to rotate AVL Node right to help with balancing.
        """
        rot_node = node.left
        temp = rot_node.right
    ...
    def _update_height(self, node: AVLNode) -> None:
        """
        Method: _update_height()
        Parameters: node: AVLNode
        Returns: None
        Description: Adds one to the height of a node that got added.
        """
    ...
    def _rebalance(self, node: AVLNode) -> None:
        ...
        Parameters: node: AVLNode
        Returns: None
        Description: Checks the 4 possible cases for the imbalanced AVL Tree and uses rotation helper methods to adjust.
        """
